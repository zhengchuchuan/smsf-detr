...
RUN_DIR="outputs/HOD1_rgb_msi/rtmsfdetr/rtv4_hgnetv2_m_distill_det_dualstream_c2former_postblock_add_wbadd_c3c4c5_msbandsep_c2align_infonce_reg_globalkv_pos2d/260203-114053-rtmsfdetr_hod1_rgb_msi_20260115_det_rtv4_hgnetv2_m_distill_dualstream_c2former_postblock_add_wbadd_c3c4c5_msbandsep_c2align_infonce_reg_globalkv_pos2d"
...
DATASET_DIR="${DATASET_DIR:-"data/HOD-1"}"
RGB_DIR="${RGB_DIR:-}"
MSI_DIR="${MSI_DIR:-}"
