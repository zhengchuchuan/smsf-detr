...
class WindowedDinov2WithRegistersConfig(BackboneConfigMixin, PretrainedConfig):
    ...
    Args:
        ...
        image_size (`int`, *optional*, defaults to 224):
            The size (img_size) of each image.
        patch_size (`int`, *optional*, defaults to 16):
            The size (img_size) of each patch.
...
class WindowedDinov2WithRegistersEmbeddings(nn.Module):
    ...
    def interpolate_pos_encoding(self, embeddings: torch.Tensor, height: int, width: int) -> torch.Tensor:
        ...
        img_size images. This implementation supports torch.jit tracing while maintaining backwards compatibility
        ...
        if hasattr(torch, "onnx") and hasattr(torch.onnx, "is_in_onnx_export") and torch.onnx.is_in_onnx_export():
            antialias = False
