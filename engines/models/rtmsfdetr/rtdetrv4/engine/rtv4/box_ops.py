...
def generalized_box_iou(boxes1, boxes2):
    ...
    and M = len(boxes2)
    """
    # Robustness: training may transiently produce NaN/Inf or degenerate boxes (especially with AMP / new fusion blocks).
    # Instead of asserting, sanitize to avoid crashing matcher/loss in validation.
    def _sanitize_xyxy(boxes: Tensor) -> Tensor:
    ...
    return torch.nan_to_num(giou, nan=0.0, posinf=0.0, neginf=0.0)
