...
try:
    import faster_coco_eval  # type: ignore
    import faster_coco_eval.core.mask as coco_mask  # type: ignore

    torchvision.disable_beta_transforms_warning()
    faster_coco_eval.init_as_pycocotools()
except ModuleNotFoundError:
    # `faster_coco_eval` is an optional acceleration dependency.
    # Fall back to pycocotools-compatible mask utils so the engine can import/run.
