        ...
        if self.align_enabled:
            ...
            if align_type_raw == "crgga":
                ...
                self.aligner = GroupwiseDeformableAlign2D(
                    ...
                    infonce_weight=float(_cfg_value(cfg, "infonce_weight", 1.0)),
                    lncc_weight=float(_cfg_value(cfg, "lncc_weight", 0.2)),
                    lncc_window_size=int(_cfg_value(cfg, "lncc_window_size", 5)),
                    lncc_eps=float(_cfg_value(cfg, "lncc_eps", 1e-6)),
